...
namespace LiteMol.Custom {
    ...
    export const DownloadAndCreate = Bootstrap.Tree.Transformer.action<Entity.Root, Entity.Action, { id?: string }>({
        ...
        action.add(a, <Bootstrap.Tree.Transformer.To<Entity.Data.Binary>>Transformer.Data.Download, { url: `http://www.ebi.ac.uk/pdbe/coordinates/files/${id}.ccp4`, type: 'Binary', id, description: '2Fo-Fc Density' })
            .then(Transformer.Density.ParseBinary, { format: LiteMol.Core.Formats.Density.SupportedFormats.CCP4, id: '2Fo-Fc Density', normalize: false }, { isBinding: true })
