...
namespace LiteMol.Viewer.PDBe.Validation {
    ...
    export const DownloadAndCreate = Bootstrap.Tree.Transformer.action<Entity.Molecule.Molecule, Entity.Action, { }>({
        ...
        let action = Bootstrap.Tree.Transform.build()
            .add(a, <Bootstrap.Tree.Transformer.To<Entity.Data.String>>Transformer.Data.Download, { url: `http://www.ebi.ac.uk/pdbe/api/validation/residuewise_outlier_summary/entry/${id}`, type: 'String', id, description: 'Validation Data' })
