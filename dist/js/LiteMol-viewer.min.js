 ...
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
var LiteMol;(function(e){var r;(function(r){var t;(function(r){var t=e.Core.Utils;var a=e.Core.Structure;var o=a.Query;var n=10;var i=2;function s(n,i,s){return __awaiter(this,void 0,e.Promise,function(){var e,u,d,p,f,h,v,B,A,y,g,C,b,D,T,S,M,w,x,V,U,E,I,P,F,R,L,_,k,N,W,G,z,Y,V,U,E,I,O,q,Z,Q,N,H,X,j,K,J,$,ee,N,H,re,te,ae,N,H,oe;return __generator(this,function(ne){switch(ne.label){case 0:return[4,n.updateProgress("Determing main sequence atoms...")];case 1:ne.sent();e=m(i,s);u=i.data.modifiedResidues;d=u&&u.count>0;if(e.length===s.atomCount&&!d){p={sequence:{all:e,interacting:[],modified:[]},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInto},freeWaterAtoms:[]};return[2,p]}f=o.Context.ofAtomIndices(i,e);h=l(i,f);if(e.length===s.atomCount){v={sequence:{all:e,interacting:[],modified:h},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInto},freeWaterAtoms:[]};return[2,v]}B=o.entities({type:"water"}).union().compile()(s).unionAtomIndices();A=o.or(o.atomsFromIndices(B),o.atomsFromIndices(e)).complement().ambientResidues(c(i)).union().compile();y=A(s).fragments[0];if(!y){g={sequence:{all:e,interacting:[],modified:h},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInto},freeWaterAtoms:B};return[2,g]}return[4,n.updateProgress("Computing bonds...")];case 2:ne.sent();C=a.computeBonds(i,y.atomIndices);b=i.data.atoms,D=b.entityIndex,T=b.residueIndex;S=i.data.entities.type;M=C.atomAIndex,w=C.atomBIndex;return[4,n.updateProgress("Identifying free waters...")];case 3:ne.sent();x=t.FastSet.create();for(V=0,U=C.count;V<U;V++){E=M[V],I=w[V];P=S[D[E]],F=S[D[I]];if(P==="water"){if(F!=="water")x.add(T[E])}else if(F==="water"){x.add(T[I])}}R=new Int32Array(B.length-x.size);L=0;for(_=0,k=B;_<k.length;_++){N=k[_];if(!x.has(N))R[L++]=N}return[4,n.updateProgress("Identifying HET groups...")];case 4:ne.sent();W=f.mask;G=t.ChunkedArray.forInt32(y.atomCount/2);z=t.FastSet.create(),Y=t.FastSet.create();for(V=0,U=C.count;V<U;V++){E=M[V],I=w[V];O=W.has(E),q=W.has(I);if(O){if(!q){z.add(T[E]);Y.add(I)}}else if(q){z.add(T[I]);Y.add(E)}}for(Z=0,Q=y.atomIndices;Z<Q.length;Z++){N=Q[Z];H=T[N];if(W.has(N)&&!z.has(H))continue;if(S[D[N]]==="water"&&!x.has(H))continue;t.ChunkedArray.add(G,N)}X=t.ChunkedArray.compact(G);return[4,n.updateProgress("Identifying carbohydrates...")];case 5:ne.sent();j=r.Carbohydrates.getInfo({model:i,fragment:o.Fragment.ofArray(s,X[0],X),atomMask:s.mask,bonds:C});return[4,n.updateProgress("Identifying non-carbohydrate HET groups...")];case 6:ne.sent();K=t.ChunkedArray.forInt32(X.length);J=j.map;for($=0,ee=X;$<ee.length;$++){N=ee[$];H=T[N];if(!J.has(H)&&!W.has(N))t.ChunkedArray.add(K,N)}return[4,n.updateProgress("Identifying interacting sequence residues...")];case 7:ne.sent();re=t.ChunkedArray.forInt32(X.length);for(te=0,ae=X;te<ae.length;te++){N=ae[te];H=T[N];if(z.has(H)||Y.has(N)&&!J.has(H))t.ChunkedArray.add(re,N)}oe={sequence:{all:e,interacting:t.ChunkedArray.compact(re),modified:h},het:{other:t.ChunkedArray.compact(K),carbohydrates:j},freeWaterAtoms:R};return[2,oe]}})})}r.createComplexRepresentation=s;function l(e,r){var t=e.data.modifiedResidues;var a=t&&t.count>0;if(!t||!a)return[];var n=t.asymId,i=t.seqNumber,s=t.insCode;var l=[];for(var c=0,u=t.count;c<u;c++){l.push({asymId:n[c],seqNumber:i[c],insCode:s[c]})}var m=o.residues.apply(null,l).compile();return m(r).unionAtomIndices()}function c(e){var r=3;if(e.data.bonds.structConn){for(var t=0,a=e.data.bonds.structConn.entries;t<a.length;t++){var o=a[t];if(o.distance>r)r=o.distance}}return r+.1}function u(e,r,t){var a=e.data.secondaryStructure;var o=e.data.chains,n=o.residueStartIndex,i=o.residueEndIndex;var s=e.data.residues,l=s.atomStartIndex,c=s.atomEndIndex,u=s.secondaryStructureIndex;var m=0;var d=false,p=false;for(var f=n[r],h=i[r];f<h;f++){var v=a[u[f]].type;if(v===5){p=true}else if(v!==0){d=true}for(var B=l[f],A=c[f];B<A;B++){if(t.has(B)){m++;break}}}return{length:m,isAmk:d,isNucleotide:p}}function m(e,r){var a=r.mask;var o=e.data.chains,s=o.residueStartIndex,l=o.residueEndIndex;var c=e.data.residues,m=c.atomStartIndex,d=c.atomEndIndex;var f=t.ChunkedArray.forInt32(r.atomCount);for(var h=0,v=e.data.chains.indices;h<v.length;h++){var B=v[h];var A=u(e,B,a),y=A.length,g=A.isAmk,C=A.isNucleotide;if(g&&y<=n||C&&y<=i)continue;for(var b=s[B],D=l[B];b<D;b++){if(!p(e,a,b))continue;for(var T=m[b],S=d[b];T<S;T++){if(a.has(T)){t.ChunkedArray.add(f,T)}}}}return t.ChunkedArray.compact(f)}function d(e,r,t,a,o,n,i){var s=false,l=false,c=false;for(var u=r;u<t;u++){if(!e.has(u))continue;var m=a[u];if(!s&&m===o){s=true}else if(!l&&m===n){l=true}if(s&&l)return true;if(m==="P"){c=true}}if(i)return s;return c}function p(e,r,t){var a=e.data,o=a.secondaryStructure,n=a.residues,i=a.atoms;var s=n.atomStartIndex,l=n.atomEndIndex,c=n.secondaryStructureIndex;var u=o[c[t]].type;if(u===0)return false;var m=i.name;if(u===5){return d(r,s[t],l[t],m,"O5'","C3'",false)}else{return d(r,s[t],l[t],m,"CA","O",true)}}})(t=r.ComplexReprensetation||(r.ComplexReprensetation={}))})(r=e.Extensions||(e.Extensions={}))})(LiteMol||(LiteMol={}));/*
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
var LiteMol;(function(e){var r;(function(r){var t;(function(r){var t;(function(t){var a=this;var o=e.Bootstrap.Entity;var n=e.Bootstrap.Entity.Transformer;var i=e.Bootstrap.Tree;var s=e.Core.Structure.Query;t.ComplexInfo=o.create({name:"Macromolecular Complex Info",typeClass:"Object",shortName:"MC",description:"Information about a macromolecular complex."});t.CreateComplexInfo=i.Transformer.create({id:"complex-representation-create-info",name:"Complex Info",description:"Information about macromolecular complex (Main sequence, ligands, etc.).",from:[o.Molecule.Model,o.Molecule.Selection],to:[t.ComplexInfo],isUpdatable:false,defaultParams:function(){return{}}},function(o,n,i){return e.Bootstrap.Task.create("Complex","Normal",function(o){return __awaiter(a,void 0,void 0,function(){var a,s,l;return __generator(this,function(c){switch(c.label){case 0:a=e.Bootstrap.Utils.Molecule.findModel(n);s=e.Bootstrap.Utils.Molecule.findQueryContext(n);return[4,r.createComplexRepresentation(o,a.props.model,s)];case 1:l=c.sent();return[2,t.ComplexInfo.create(i,{label:"Complex",info:l})]}})})}).setReportTime(true)});t.CreateVisual=i.Transformer.actionWithContext({id:"complex-representation-create-visual",name:"Complex Visual",description:"Create a visual of a macromolecular complex.",from:[t.ComplexInfo],to:[o.Action],defaultParams:function(e){return{}}},function(t,a,o){var l=i.Transform.build();var c=a.props.info;if(c.sequence.all.length){var u=l.add(a,n.Basic.CreateGroup,{label:"Sequence",description:""},{isBinding:true});u.then(n.Molecule.CreateSelectionFromQuery,{query:s.atomsFromIndices(c.sequence.all),name:"All Residues",silent:true},{isBinding:true}).then(n.Molecule.CreateVisual,{style:e.Bootstrap.Visualization.Molecule.Default.ForType.get("Cartoons")},{});var m={type:"BallsAndSticks",taskType:"Silent",params:{useVDW:true,vdwScaling:.21,bondRadius:.085,detail:"Automatic"},theme:{template:e.Bootstrap.Visualization.Molecule.Default.CartoonThemeTemplate,colors:e.Bootstrap.Visualization.Molecule.Default.CartoonThemeTemplate.colors,transparency:{alpha:1}},isNotSelectable:true};if(c.sequence.interacting.length){u.then(n.Molecule.CreateSelectionFromQuery,{query:s.atomsFromIndices(c.sequence.interacting),name:"Interacting Residues",silent:true},{isBinding:true}).then(n.Molecule.CreateVisual,{style:m})}if(c.sequence.modified.length){u.then(n.Molecule.CreateSelectionFromQuery,{query:s.atomsFromIndices(c.sequence.modified),name:"Modified Residues",silent:true},{isBinding:true}).then(n.Molecule.CreateVisual,{style:m})}}if(c.het.other.length||c.het.carbohydrates.entries.length){var d=l.add(a,n.Basic.CreateGroup,{label:"HET",description:""},{isBinding:true});if(c.het.other.length){d.then(n.Molecule.CreateSelectionFromQuery,{query:s.atomsFromIndices(c.het.other),name:"Ligands",silent:true}).then(n.Molecule.CreateVisual,{style:e.Bootstrap.Visualization.Molecule.Default.ForType.get("BallsAndSticks")},{isBinding:true})}if(c.het.carbohydrates.entries.length){var p={type:"BallsAndSticks",taskType:"Silent",params:{useVDW:false,atomRadius:.15,bondRadius:.07,detail:"Automatic"},theme:{template:e.Bootstrap.Visualization.Molecule.Default.ElementSymbolThemeTemplate,colors:e.Bootstrap.Visualization.Molecule.Default.ElementSymbolThemeTemplate.colors,transparency:{alpha:.15}},isNotSelectable:true};var f=s.or(s.residuesFromIndices(c.het.carbohydrates.carbohydrateIndices),s.residuesFromIndices(c.het.carbohydrates.terminalIndices)).union();var h=d.then(e.Bootstrap.Entity.Transformer.Molecule.CreateSelectionFromQuery,{query:f,name:"Std. Carbohydrates",silent:true},{});h.then(e.Bootstrap.Entity.Transformer.Molecule.CreateVisual,{style:p});h.then(r.Carbohydrates.Transforms.CreateInfo,{info:c.het.carbohydrates}).then(r.Carbohydrates.Transforms.CreateVisual,r.Carbohydrates.DefaultFullParams,{isBinding:true})}}if(c.freeWaterAtoms.length){var v={type:"BallsAndSticks",params:{useVDW:false,atomRadius:.15,bondRadius:.07,detail:"Automatic"},theme:{template:e.Bootstrap.Visualization.Molecule.Default.ElementSymbolThemeTemplate,colors:e.Bootstrap.Visualization.Molecule.Default.ElementSymbolThemeTemplate.colors,transparency:{alpha:.2}}};l.add(a,n.Molecule.CreateSelectionFromQuery,{query:s.atomsFromIndices(c.freeWaterAtoms),name:"Unbound Water",silent:true},{isBinding:true}).then(n.Molecule.CreateVisual,{style:v},{})}return{action:l,context:{warnings:c.het.carbohydrates.warnings}}},function(e,r){if(!r)return;for(var t=0,a=r.warnings;t<a.length;t++){var o=a[t];e.logger.warning("Carbohydrates: "+o)}});t.SuppressCreateVisualWhenModelIsAdded=false;function l(r){e.Bootstrap.Event.Tree.NodeAdded.getStream(r).subscribe(function(a){if(t.SuppressCreateVisualWhenModelIsAdded||!e.Bootstrap.Tree.Node.is(a.data,e.Bootstrap.Entity.Molecule.Model)||a.data.isHidden){return}var o=e.Bootstrap.Tree.Transform.build().add(a.data,t.CreateComplexInfo,{}).then(t.CreateVisual,{},{isBinding:true});e.Bootstrap.Tree.Transform.apply(r,o).run().then(function(){e.Bootstrap.Command.Visual.ResetScene.dispatch(r,void 0)})})}t.CreateRepresentationWhenModelIsAddedBehaviour=l})(t=r.Transforms||(r.Transforms={}))})(t=r.ComplexReprensetation||(r.ComplexReprensetation={}))})(r=e.Extensions||(e.Extensions={}))})(LiteMol||(LiteMol={}));/*
 * Copyright (c) 2016 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
