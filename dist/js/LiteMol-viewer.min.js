var LiteMol;(function(e){var r;(function(e){e.VERSION={number:"1.6.4",date:"Sep 18 2017"}})(r=e.Viewer||(e.Viewer={}))})(LiteMol||(LiteMol={}));/*
 ...
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
var LiteMol;(function(e){var r;(function(r){var t;(function(r){var t;(function(r){var t=e.Core.Structure;var a=e.Core.Geometry.LinearAlgebra;var o=e.Bootstrap.Entity;var n=e.Bootstrap.Tree;r.Types=["Icons","Full"];r.FullSizes=["Small","Medium","Large"];r.DefaultIconsParams={type:"Icons",iconScale:.55};r.DefaultFullParams={type:"Full",fullSize:"Large",linkColor:e.Visualization.Color.fromRgb(255*.6,255*.6,255*.6),showTerminalLinks:true,showTerminalAtoms:false};function i(e,t){var a=e.data.residues.name;for(var o=0,n=t;o<n.length;o++){var i=n[o];if(!r.Mapping.isResidueRepresentable(a[i]))return true}return false}r.isRepresentable=i;var s;(function(t){var a=this;t.CarbohydratesInfo=o.create({name:"Carbohydrate Information",typeClass:"Object",shortName:"CI",description:"Information about carbohydrate residues."});t.CreateInfo=n.Transformer.create({id:"carbohydrate-representation-create-info",name:"Carbohydrates",description:"Information about carbohydrate residues.",from:[o.Molecule.Model],to:[t.CarbohydratesInfo],isApplicable:function(){return false},isUpdatable:false,defaultParams:function(){return{}}},function(r,a,o){return e.Bootstrap.Task.resolve("Carbohydrates","Silent",t.CarbohydratesInfo.create(o,{label:"Carbohydrates",info:o.params.info}))});t.CreateVisual=n.Transformer.create({id:"carbohydrate-representation-create-visual",name:"3D-SNFG",description:"Create carbohydrate representation using 3D-SNFG shapes.",from:[t.CarbohydratesInfo],to:[o.Molecule.Visual],isUpdatable:true,defaultParams:function(){return r.DefaultFullParams}},function(r,t,o){return e.Bootstrap.Task.create("Carbohydrate Representation","Background",function(r){return __awaiter(a,void 0,void 0,function(){var a,n,i,s,l,u,m,d,p,f,h,v;return __generator(this,function(B){switch(B.label){case 0:a=e.Bootstrap.Utils.Molecule.findModel(t);if(!a)throw Error("Carbohydrate representation requires a Molecule.Model entity ancestor.");n=c(a.props.model,t.props.info,o.params),i=n.surface,s=n.theme,l=n.tags,u=n.mapper;p=(d=e.Visualization.Surface.Model).create;f=[t];h={};return[4,i.run(r)];case 1:return[4,p.apply(d,f.concat([(h.surface=B.sent(),h.theme=s,h.parameters={mapPickElements:u},h)])).run(r)];case 2:m=B.sent();v={type:"Surface",taskType:"Background",params:{},theme:void 0};return[2,e.Bootstrap.Entity.Molecule.Visual.create(o,{label:"3D-SNFG",model:m,style:v,isSelectable:true,tag:l})]}})})}).setReportTime(true)},function(r,t,a){var o=__assign({},t.transform.params);var i=__assign({},a.params);if(o.type!=="Full"||i.type!=="Full")return void 0;delete o.linkColor;delete i.linkColor;if(!e.Bootstrap.Utils.deepEqual(o,i))return void 0;var s=t.props.tag.colors;var l=e.Visualization.Theme.createColorMapMapping(function(e){return e},s,a.params.type==="Full"?a.params.linkColor:e.Visualization.Color.fromHexString("#666666"));var c=e.Visualization.Theme.createMapping(l);t.props.model.applyTheme(c);return e.Bootstrap.Task.resolve(a.transformer.info.name,"Background",n.Node.Null)})})(s=r.Transforms||(r.Transforms={}));r.EmptyInto={links:[],map:e.Core.Utils.FastMap.create(),entries:[],carbohydrateIndices:[],terminalIndices:[],warnings:[]};function l(t){var a=t.model,o=t.fragment,n=t.atomMask,i=t.bonds;var s=f(a,o.residueIndices),l=s.residueIndices,c=s.entries,u=s.warnings;if(!l.length){return r.EmptyInto}var m=e.Core.Utils.FastMap.create();for(var p=0,h=l.length;p<h;p++){m.set(l[p],p)}var v=d({model:a,atomMask:n,bonds:i,carbohydrateMap:m,entries:c}),B=v.links,A=v.terminalIndices;return{links:B,map:m,entries:c,carbohydrateIndices:l,terminalIndices:A,warnings:u}}r.getInfo=l;function c(a,o,n){var i=o.carbohydrateIndices,s=o.entries,l=o.links;var c=e.Visualization.Primitive.Builder.create();var m=e.Core.Utils.FastMap.create();var d=e.Core.Utils.FastMap.create();var p=n.type==="Full"?n.fullSize==="Small"?.55:n.fullSize==="Medium"?.75:1.1:n.iconScale;var f=0;for(var h=0;h<i.length;h++){var v=s[h].representation;var B=r.Shapes.makeTransform(a,s[h],p,n.type);var A=0;for(var y=0,g=v.shape;y<g.length;y++){var C=g[y];d.set(f,v.color[A++]);m.set(f,{type:"Residue",instanceName:v.instanceName,residueIndex:i[h],model:a});c.add(__assign({type:"Surface",surface:C,id:f++},B))}}if(n.type==="Full"){var b=n.showTerminalLinks,D=n.showTerminalAtoms;var T=n.fullSize==="Small"?.12:n.fullSize==="Medium"?.2:.28;for(var S=0,M=l;S<M.length;S++){var w=M[S];switch(w.type){case"Carbohydrate":{var x=w.centerA,V=w.centerB;c.add({type:"Tube",id:f++,radius:T,slices:12,a:x,b:V});break}case"Terminal":{if(!b)continue;var U=w.rB,E=w.bondType,x=w.centerA,V=w.centerB;if(t.isBondTypeCovalent(E)){c.add({type:"Tube",id:f++,radius:T/2,slices:8,a:x,b:V})}else{c.add({type:"DashedLine",id:f++,width:T/2,dashSize:.33,spaceSize:.33,a:x,b:V})}if(D){var I=2*T;m.set(f,{type:"Terminal",residueIndex:U,model:a});c.add({type:"Surface",surface:r.Shapes.Sphere,id:f++,scale:[I,I,I],translation:V})}break}}}}var F=e.Visualization.Theme.createColorMapMapping(function(e){return e},d,n.type==="Full"?n.linkColor:e.Visualization.Color.fromHexString("#666666"));var P=e.Visualization.Theme.createMapping(F);var R={type:"CarbohydrateRepresentation",colors:d};return{surface:c.buildSurface(),mapper:u(a,m),tags:R,theme:P}}r.getRepresentation=c;function u(e,r){var t=e.data.residues,a=t.atomStartIndex,o=t.atomEndIndex;return function(e){var t=r.get(e);if(!t)return void 0;var n=[];if(t.type!=="Link"){for(var i=a[t.residueIndex],s=o[t.residueIndex];i<s;i++)n.push(i)}else{var l=t.link.rA;for(var i=a[l],s=o[l];i<s;i++)n.push(i);l=t.link.rB;for(var i=a[l],s=o[l];i<s;i++)n.push(i)}return n}}function m(e){return{type:e.type,rA:e.rB,rB:e.rA,atomA:e.atomB,atomB:e.atomA,centerA:e.centerB,centerB:e.centerA,bondType:e.bondType}}function d(r){var t=r.model,o=r.bonds,n=r.atomMask,i=r.carbohydrateMap,s=r.entries;var l=o.atomAIndex,c=o.atomBIndex,u=o.type;var d=t.data.atoms.residueIndex;var p=t.positions,f=p.x,h=p.y,v=p.z;var B=e.Core.Utils.FastSet.create();var A=[];var y=e.Core.Utils.UniqueArray();for(var g=0,C=o.count;g<C;g++){var b=l[g],D=c[g];if(!n.has(b)||!n.has(D))continue;var T=Math.min(b,D),S=Math.max(b,D);var M=d[T],w=d[S];var x=i.has(M),V=i.has(w);var U=u[g];if(x&&V){if(M===w)continue;var E=M+" "+w;if(B.has(E))continue;B.add(E);var I=s[i.get(M)],F=s[i.get(w)];var P={type:"Carbohydrate",rA:M,rB:w,atomA:T,atomB:S,centerA:I.ringCenter,centerB:F.ringCenter,bondType:U};A.push(P);I.links.push(P);F.links.push(m(P))}else if(x){var I=s[i.get(M)];var P={type:"Terminal",rA:M,rB:w,atomA:T,atomB:S,centerA:I.ringCenter,centerB:a.Vector3(f[S],h[S],v[S]),bondType:U};A.push(P);I.terminalLinks.push(P);e.Core.Utils.UniqueArray.add(y,w)}else if(V){var F=s[i.get(w)];var P={type:"Terminal",rA:w,rB:M,atomA:S,atomB:T,centerA:F.ringCenter,centerB:a.Vector3(f[T],h[T],v[T]),bondType:U};A.push(P);F.terminalLinks.push(P);e.Core.Utils.UniqueArray.add(y,M)}}return{links:A,terminalIndices:y.array}}function p(e,t){return"Residue '"+r.formatResidueName(e,t)+"' has a recognized carbohydrate name, but missing/incorrectly named ring atoms."}function f(t,o){var n=t.data.residues.name;var i=[],s=[],l=[];for(var c=0,u=o;c<u.length;c++){var m=u[c];if(!r.Mapping.isResidueRepresentable(n[m]))continue;var d=h(t,m);if(!d.length){l.push(p(t,m));continue}var f=false;for(var v=0,B=d;v<B.length;v++){var A=B[v];var y=a.Vector3.zero();var g=e.Bootstrap.Utils.Molecule.getCentroidAndRadius(t,A,y);if(g>1.95){continue}i.push(m);s.push({representation:r.Mapping.getResidueRepresentation(n[m]),ringAtoms:A,ringCenter:y,ringRadius:g,links:[],terminalLinks:[]});f=true;break}if(!f){l.push(p(t,m))}}return{residueIndices:i,entries:s,warnings:l}}function h(e,t){var a=e.data.residues,o=a.atomStartIndex,n=a.atomEndIndex;var i=e.data.atoms.name;var s=[];for(var l=0,c=r.Mapping.RingNames;l<c.length;l++){var u=c[l];var m=[];var d=0;for(var p=0;p<u.__len;p++)m.push(0);for(var f=o[t],h=n[t];f<h;f++){var v=u[i[f]];if(v===void 0)continue;m[v]=f;d++;if(d===m.length)s.push(m)}}return s}})(t=r.Carbohydrates||(r.Carbohydrates={}))})(t=r.ComplexReprensetation||(r.ComplexReprensetation={}))})(r=e.Extensions||(e.Extensions={}))})(LiteMol||(LiteMol={}));/*
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
