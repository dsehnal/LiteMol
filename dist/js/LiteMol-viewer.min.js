 ...
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
var LiteMol;(function(e){var r;(function(r){var t;(function(r){var t=e.Core.Utils;var a=e.Core.Structure;var o=a.Query;var n=10;var i=2;function s(e,n,i){return __awaiter(this,void 0,void 0,function(){var s,u,d,p,f,h,v,B,A,y,g,C,b,T,D,S,M,w,x,V,E,U,I,F,P,R,L,_,k,N,W,G,z,Y,V,E,U,I,O,q,Z,Q,N,X,H,j,K,J,$,ee,N,X,re,te,ae,N,X,oe;return __generator(this,function(ne){switch(ne.label){case 0:return[4,e.updateProgress("Determing main sequence atoms...")];case 1:ne.sent();s=m(n,i);u=n.data.modifiedResidues;d=u&&u.count>0;if(s.length===i.atomCount&&!d){p={sequence:{all:s,interacting:[],modified:[]},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInfo([])},freeWaterAtoms:[]};return[2,p]}f=o.Context.ofAtomIndices(n,s);h=l(n,f);if(s.length===i.atomCount){v={sequence:{all:s,interacting:[],modified:h},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInfo([])},freeWaterAtoms:[]};return[2,v]}B=o.entities({type:"water"}).union().compile()(i).unionAtomIndices();A=o.or(o.atomsFromIndices(B),o.atomsFromIndices(s)).complement().ambientResidues(c(n)).union().compile();y=A(i).fragments[0];if(!y){g={sequence:{all:s,interacting:[],modified:h},het:{other:[],carbohydrates:r.Carbohydrates.EmptyInfo([])},freeWaterAtoms:B};return[2,g]}return[4,e.updateProgress("Computing bonds...")];case 2:ne.sent();C=a.computeBonds(n,y.atomIndices);b=n.data.atoms,T=b.entityIndex,D=b.residueIndex;S=n.data.entities.type;M=C.atomAIndex,w=C.atomBIndex;return[4,e.updateProgress("Identifying free waters...")];case 3:ne.sent();x=t.FastSet.create();for(V=0,E=C.count;V<E;V++){U=M[V],I=w[V];F=S[T[U]],P=S[T[I]];if(F==="water"){if(P!=="water")x.add(D[U])}else if(P==="water"){x.add(D[I])}}R=new Int32Array(B.length-x.size);L=0;for(_=0,k=B;_<k.length;_++){N=k[_];if(!x.has(N))R[L++]=N}return[4,e.updateProgress("Identifying HET groups...")];case 4:ne.sent();W=f.mask;G=t.ChunkedArray.forInt32(y.atomCount/2);z=t.FastSet.create(),Y=t.FastSet.create();for(V=0,E=C.count;V<E;V++){U=M[V],I=w[V];O=W.has(U),q=W.has(I);if(O){if(!q){z.add(D[U]);Y.add(I)}}else if(q){z.add(D[I]);Y.add(U)}}for(Z=0,Q=y.atomIndices;Z<Q.length;Z++){N=Q[Z];X=D[N];if(W.has(N)&&!z.has(X))continue;if(S[T[N]]==="water"&&!x.has(X))continue;t.ChunkedArray.add(G,N)}H=t.ChunkedArray.compact(G);return[4,e.updateProgress("Identifying carbohydrates...")];case 5:ne.sent();j=r.Carbohydrates.getInfo({model:n,fragment:o.Fragment.ofArray(i,H[0],H),atomMask:i.mask,bonds:C});return[4,e.updateProgress("Identifying non-carbohydrate HET groups...")];case 6:ne.sent();K=t.ChunkedArray.forInt32(H.length);J=j.map;for($=0,ee=H;$<ee.length;$++){N=ee[$];X=D[N];if(!J.has(X)&&!W.has(N))t.ChunkedArray.add(K,N)}return[4,e.updateProgress("Identifying interacting sequence residues...")];case 7:ne.sent();re=t.ChunkedArray.forInt32(H.length);for(te=0,ae=H;te<ae.length;te++){N=ae[te];X=D[N];if(z.has(X)||Y.has(N)&&!J.has(X))t.ChunkedArray.add(re,N)}oe={sequence:{all:s,interacting:t.ChunkedArray.compact(re),modified:h},het:{other:t.ChunkedArray.compact(K),carbohydrates:j},freeWaterAtoms:R};return[2,oe]}})})}r.createComplexRepresentation=s;function l(e,r){var t=e.data.modifiedResidues;var a=t&&t.count>0;if(!t||!a)return[];var n=t.asymId,i=t.seqNumber,s=t.insCode;var l=[];for(var c=0,u=t.count;c<u;c++){l.push({asymId:n[c],seqNumber:i[c],insCode:s[c]})}var m=o.residues.apply(null,l).compile();return m(r).unionAtomIndices()}function c(e){var r=3;if(e.data.bonds.structConn){for(var t=0,a=e.data.bonds.structConn.entries;t<a.length;t++){var o=a[t];if(o.distance>r)r=o.distance}}return r+.1}function u(e,r,t){var a=e.data.secondaryStructure;var o=e.data.chains,n=o.residueStartIndex,i=o.residueEndIndex;var s=e.data.residues,l=s.atomStartIndex,c=s.atomEndIndex,u=s.secondaryStructureIndex;var m=0;var d=false,p=false;for(var f=n[r],h=i[r];f<h;f++){var v=a[u[f]].type;if(v===5){p=true}else if(v!==0){d=true}for(var B=l[f],A=c[f];B<A;B++){if(t.has(B)){m++;break}}}return{length:m,isAmk:d,isNucleotide:p}}function m(e,r){var a=r.mask;var o=e.data.chains,s=o.residueStartIndex,l=o.residueEndIndex;var c=e.data.residues,m=c.atomStartIndex,d=c.atomEndIndex;var f=t.ChunkedArray.forInt32(r.atomCount);for(var h=0,v=e.data.chains.indices;h<v.length;h++){var B=v[h];var A=u(e,B,a),y=A.length,g=A.isAmk,C=A.isNucleotide;if(g&&y<=n||C&&y<=i)continue;for(var b=s[B],T=l[B];b<T;b++){if(!p(e,a,b))continue;for(var D=m[b],S=d[b];D<S;D++){if(a.has(D)){t.ChunkedArray.add(f,D)}}}}return t.ChunkedArray.compact(f)}function d(e,r,t,a,o,n,i){var s=false,l=false,c=false;for(var u=r;u<t;u++){if(!e.has(u))continue;var m=a[u];if(!s&&m===o){s=true}else if(!l&&m===n){l=true}if(s&&l)return true;if(m==="P"){c=true}}if(i)return s;return c}function p(e,r,t){var a=e.data,o=a.secondaryStructure,n=a.residues,i=a.atoms;var s=n.atomStartIndex,l=n.atomEndIndex,c=n.secondaryStructureIndex;var u=o[c[t]].type;if(u===0)return false;var m=i.name;if(u===5){return d(r,s[t],l[t],m,"O5'","C3'",false)}else{return d(r,s[t],l[t],m,"CA","O",true)}}})(t=r.ComplexReprensetation||(r.ComplexReprensetation={}))})(r=e.Extensions||(e.Extensions={}))})(LiteMol||(LiteMol={}));/*
 * Copyright (c) 2017 - now David Sehnal, licensed under Apache 2.0, See LICENSE file for more info.
 */
