 ...
 */
namespace LiteMol.Core.Utils.FastNumberParsers {
    "use strict";

    export function parseIntSkipTrailingWhitespace(str: string, start: number, end: number) {
    ...
    export function parseFloatSkipTrailingWhitespace(str: string, start: number, end: number) {
        while (start < end && str.charCodeAt(start) === 32) start++;
