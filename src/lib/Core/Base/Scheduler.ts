...
namespace LiteMol.Core.Scheduler {
    "use strict";
    ...
    export const immediate = immediateActions.setImmediate;
    export const clearImmediate = immediateActions.clearImmediate;

    export function immediatePromise() { return new Promise<void>(resolveImmediate); }
}