...
========
  ...
  - `AngularExample` [ [source](https://github.com/dsehnal/LiteMol/tree/master/examples/AngularExample) ] - Shows how to wrap the LiteMol plugin in Angular Directive. Thanks to @mjamroz for contributing the basis for the example.
