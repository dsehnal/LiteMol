...
namespace LiteMol.Custom {
    ...
    export const DownloadAndCreate = Bootstrap.Tree.Transformer.action<Entity.Root, Entity.Action, { id?: string }>({
        ...
        action.add(a, <Bootstrap.Tree.Transformer.To<Bootstrap.Entity.Data.Binary | Bootstrap.Entity.Data.String>>Transformer.Data.Download, { url: `https://www.ebi.ac.uk/pdbe/entry-files/pdb${id}.ent`, type: 'String', id })
        ...
        action.add(a, <Bootstrap.Tree.Transformer.To<Entity.Data.Binary | Entity.Data.String>>Transformer.Data.Download, { url: `https://www.ebi.ac.uk/pdbe/coordinates/files/${id}.ccp4`, type: 'Binary', id, description: '2Fo-Fc Density' })
